...
class AppSettingModel {
  ...
  AppSettingModel.fromJson(Map<String, dynamic> json) {
    ...
    referralsEnabled = json['referrals_enabled'] != null ? json['referrals_enabled'] : null;
    usdRate = json['usd_rate'] != null ? json['usd_rate'] : null;
    cancellationReasons = json['cancellation_reasons'] != null ? json['cancellation_reasons'] : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.referralsEnabled != null) {
      data['referrals_enabled'] = this.referralsEnabled;
    }
    ...
    if (this.cancellationReasons != null) {
      data['cancellation_reasons'] = this.cancellationReasons;
    }
