...
List<ChatMessageModel> getChatList() {
  ...
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: true));
  list.add(ChatMessageModel(message: 'Hellokjklj', isMessageRead: false));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;', isMessageRead: true));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: false));
  list.add(ChatMessageModel(message: 'Hellokjklj', isMessageRead: true));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;', isMessageRead: false));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: true));
  list.add(ChatMessageModel(message: 'Hellokjklj', isMessageRead: false));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;', isMessageRead: true));
  list.add(ChatMessageModel(message: 'Hellokjkljkljkljkljkl;jk;lk;k;lk;lk;k;k;k;lk;k;l', isMessageRead: false));
