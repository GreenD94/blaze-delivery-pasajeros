    ...
    return Scaffold(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(defaultRadius), color: Colors.grey.withOpacity(0.2)),
                                    padding: EdgeInsets.all(8),
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(data.type == CREDIT ? language.moneyDeposited : language.moneyDebit,
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: () async {
            String contact = WP_NUMBER;
            String message = WP_MESSAGE;
          ...
          label: const Text('Recarga Billetera / Pago Móvil'),
        ...
        //                               padding: EdgeInsets.all(8),
        //                               decoration: BoxDecoration(
        //                                 color: currentIndex == appStore.walletPresetTopUpAmount.split('|').indexOf(e)
        //                                     ? primaryColor
        //                                     : Colors.white,
        //                                 border: Border.all(
        //                                     color: currentIndex == appStore.walletPresetTopUpAmount.split('|').indexOf(e)
        ...
        //                                   Navigator.pop(context);
        //                                   launchScreen(context, PaymentScreen(amount: int.parse(addMoneyController.text)),
