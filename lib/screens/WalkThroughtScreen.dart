...
class WalkThroughtScreenState extends State<WalkThroughtScreen> {
  ...
  List<WalkThroughModel> walkThroughClass = [
    WalkThroughModel(
      ...
      text: "disfruta de tarifas accesibles \ny un servicio de calidad.",
      img: 'images/ic_walk1.jpg',
    ),
    WalkThroughModel(
      name: 'No te compliques \ncon el tráfico',
      text: "Con nuestra app \ny reserva tu viaje en segundos.",
      img: 'images/ic_walk2.jpg',
    ),
    WalkThroughModel(
      name: 'Disfruta de la comodidad \ny rapidez en tus viajes.',
      text: "Llega a tu destino con el mejor servicio",
        ...
        children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(walkThroughClass[i].text.toString(),
                            style: secondaryTextStyle(size: 14, color: Colors.white), textAlign: TextAlign.center),
                      ],
                    ),
                  ),
                ],
          ...
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text('Omitir', style: boldTextStyle(color: Colors.white)),
            ),
          ),
        ],
      ),
