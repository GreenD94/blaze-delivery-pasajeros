              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration:
                        BoxDecoration(color: primaryColor.withOpacity(0.1), borderRadius: BorderRadius.circular(defaultRadius)),
                    child: Padding(
                      padding: EdgeInsets.all(8),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                    ...
                                    decoration:
                                        InputDecoration(contentPadding: EdgeInsets.zero, hintText: language.currentLocation),
                                    onChanged: (val) {
                                      if (val.isNotEmpty) {
                                        if (val.length < 3) {
                                          listAddress.clear();
                                          ...
                                          _searchTimeout = Timer(Duration(milliseconds: 600), () async {
                                            searchAddressRequest(
                                                    search: val,
                                                    coordinates: widget.coordinates,
                                                    radius: googleMapAutocompleteRadius)
                                                .then((value) {
                                  ...
                                  TextFormField(
                                    ...
                                    autofocus: true,
                                    decoration:
                                        InputDecoration(contentPadding: EdgeInsets.zero, hintText: language.destinationLocation),
                                    onChanged: (val) {
                                      if (val.isNotEmpty) {
                                        if (val.length < 3) {
                                          listAddress.clear();
                  ...
                  AppButtonWidget(
                    ...
                    onTap: () async {
                      if (sourceFocus.hasFocus) {
                        PickResult selectedPlace = await launchScreen(context, NewGoogleMapScreen(),
                            pageRouteAnimation: PageRouteAnimation.SlideBottomTop);
                        log(selectedPlace);
