...
import 'package:taxibooking/screens/UpgradeScreen.dart';
...
class SplashScreenState extends State<SplashScreen> {
  ...
  void init() async {
    ...
    if (!(await isOutdated())) {
      ...
      launchScreen(context, UpgradeScreen(), pageRouteAnimation: PageRouteAnimation.Slide, isNewTask: true);
    }
  }
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            //         },
            //         willDisplayUpgrade: (
            //             {String? appStoreVersion, bool? display, String? installedVersion, String? minAppVersion}) {
            //           if (display != null) {
