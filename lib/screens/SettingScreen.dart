...
import 'package:taxibooking/screens/ReferralScreen.dart';
...
class SettingScreenState extends State<SettingScreen> {
  ...
  void init() async {
    await getAppSetting().then((value) {
      ...
      appStore.setEnabledReferrals(value.referralsEnabled!);
      setState(() {});
    }).catchError((error) {
      log(error.toString());
    });
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Visibility(
              visible: sharedPref.getString(LOGIN_TYPE) != 'mobile' && sharedPref.getString(LOGIN_TYPE) != null,
            ...
            settingItemWidget(Icons.assignment_outlined, language.privacyPolicy, () {
              launchScreen(context, TermsConditionScreen(title: language.privacyPolicy, subtitle: privacyPolicy),
            ...
            settingItemWidget(Icons.assignment_outlined, language.termsConditions, () {
              if (termsCondition != null) {
                launchScreen(context, TermsConditionScreen(title: language.termsConditions, subtitle: termsCondition),
                    pageRouteAnimation: PageRouteAnimation.Slide);
              } else {
                toast(language.txtURLEmpty);
              }
            ...
            if (appStore.referralsEnabled ?? false)
              settingItemWidget(
                Icons.people_outline_outlined,
                'Referido',
                () {
                  launchScreen(context, ReferralScreen(settingModel: settingModel), pageRouteAnimation: PageRouteAnimation.Slide);
                },
              ),
