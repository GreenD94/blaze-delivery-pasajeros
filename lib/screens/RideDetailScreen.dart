...
import 'package:taxibooking/screens/ComplaintScreen.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        totalCount(title: language.basePrice, description: '', subTitle: toCurrency(riderModel!.baseFare!)),
                        SizedBox(height: 16),
                        totalCount(title: language.distancePrice, description: '', subTitle: toCurrency(riderModel!.perDistanceCharge!)),
                        SizedBox(height: 16),
                        totalCount(title: language.duration, description: '', subTitle: toCurrency(riderModel!.perMinuteDriveCharge!)),
                        SizedBox(height: 16),
                        totalCount(title: language.waitTime, description: '', subTitle: toCurrency(riderModel!.perMinuteWaitingCharge!)),
                        SizedBox(height: 16),
                        if (payment != null) totalCount(title: language.tip, description: '', subTitle: toCurrency(payment!.driverTips!)),
                                ...
                                return Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(toCurrency(e.value!), style: primaryTextStyle()),
                                    ],
                                  ),
                                );
                              }).toList()
                        ...
                        if (riderModel!.couponData != null && riderModel!.couponDiscount != 0)
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                  toCurrency(riderModel!.couponDiscount!),
                                  style: primaryTextStyle(color: Colors.green)),
                            ],
                          ),
                        Divider(height: 30, thickness: 1),
                        payment!.driverTips != 0
                            ? totalCount(title: language.total, description: '', subTitle: toCurrency(riderModel!.subtotal! + payment!.driverTips!))
