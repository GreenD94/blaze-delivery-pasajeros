...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$firstNameAtom = Atom(name: '_AppStore.firstName', context: context);
  ...
  late final _$walletPresetTopUpAmountAtom = Atom(name: '_AppStore.walletPresetTopUpAmount', context: context);
  ...
  set walletPresetTopUpAmount(String value) {
    _$walletPresetTopUpAmountAtom.reportWrite(value, super.walletPresetTopUpAmount, () {
      super.walletPresetTopUpAmount = value;
    });
  }

  late final _$walletPresetTipAmountAtom = Atom(name: '_AppStore.walletPresetTipAmount', context: context);
  ...
  late final _$currencyNameAtom = Atom(name: '_AppStore.currencyName', context: context);
  ...
  late final _$rideMinutesAtom = Atom(name: '_AppStore.rideMinutes', context: context);
  ...
  late final _$minAmountToAddAtom = Atom(name: '_AppStore.minAmountToAdd', context: context);
  ...
  late final _$maxAmountToAddAtom = Atom(name: '_AppStore.maxAmountToAdd', context: context);
  ...
  late final _$setMaxAmountToAddAsyncAction = AsyncAction('_AppStore.setMaxAmountToAdd', context: context);

  @override
  Future<void> setMaxAmountToAdd(int? val) {
    return _$setMaxAmountToAddAsyncAction.run(() => super.setMaxAmountToAdd(val));
  }

  late final _$setMinAmountToAddAsyncAction = AsyncAction('_AppStore.setMinAmountToAdd', context: context);

  @override
  Future<void> setMinAmountToAdd(int? val) {
    return _$setMinAmountToAddAsyncAction.run(() => super.setMinAmountToAdd(val));
  }

  late final _$setRiderMinutesAsyncAction = AsyncAction('_AppStore.setRiderMinutes', context: context);
  ...
  late final _$setCurrencyNameAsyncAction = AsyncAction('_AppStore.setCurrencyName', context: context);
  ...
  late final _$setWalletTipAmountAsyncAction = AsyncAction('_AppStore.setWalletTipAmount', context: context);

  @override
  Future<void> setWalletTipAmount(String val) {
    return _$setWalletTipAmountAsyncAction.run(() => super.setWalletTipAmount(val));
  }

  late final _$setWalletPresetTopUpAmountAsyncAction = AsyncAction('_AppStore.setWalletPresetTopUpAmount', context: context);

  @override
  Future<void> setWalletPresetTopUpAmount(String val) {
    return _$setWalletPresetTopUpAmountAsyncAction.run(() => super.setWalletPresetTopUpAmount(val));
  }
  ...
  Future<void> setUId(String val, {bool isInitialization = false}) {
    return _$setUIdAsyncAction.run(() => super.setUId(val, isInitialization: isInitialization));
  }
  ...
  late final _$setEnabledReferralsAsyncAction = AsyncAction('_AppStore.setEnabledReferrals', context: context);

  @override
  Future<void> setEnabledReferrals(bool val) {
    return _$setEnabledReferralsAsyncAction.run(() => super.setEnabledReferrals(val));
  }
